// Trill CreatorOS · shared luxury sidebar + topbar
...
const NAV_TREE = [
  ...
  {
    type: "section", key: "insights", label: "Insights", icon: "◯",
    items: [
    ...
    <div class="h-full flex flex-col bg-[#ebe3d4]/40 border-r border-[#d6cfc4]">
      ...
      <a href="index.html" class="px-5 py-5 border-b border-[#d6cfc4] block hover:bg-[#ebe3d4]/40 transition-colors">
        <div class="flex items-baseline gap-2">
          ...
          <span class="text-[10px] uppercase tracking-widest text-[#6b5e52]">CreatorOS</span>
        </div>
      </a>
      ...
      <div class="px-4 py-3 border-t border-[#d6cfc4] text-[10px] text-[#6b5e52] italic">
        <div class="flex items-center justify-between">
          <span>An institution, not a leaderboard.</span>
        </div>
      </div>
    </div>
  `;
  ...
  return `
    <div class="h-16 bg-[#f5efe7]/95 backdrop-blur border-b border-[#d6cfc4] flex items-center px-7 gap-4">
      ...
      <div class="hidden md:flex items-center bg-[#ebe3d4] rounded-md px-3 py-1.5 w-72">
        ...
        <input type="text" placeholder="Search posts, topics, peers…" class="flex-1 bg-transparent text-xs text-[#1a1611] focus:outline-none placeholder-[#6b5e52]">
      </div>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (sidebarEl) {
    ...
    // Apply initial chevron rotation
